$(function () {
  ...
  $('body').on('click', '.editar', function(){
    ...
    var idClicado = $(objetoClicado).data('id')
  ...
  function editarVeiculo(editaVeiculoId, nome, usuarioId, marca, modelo, versao ){
    Swal.fire({
      title: 'Ateção?',
