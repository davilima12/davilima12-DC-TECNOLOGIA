        ...
        <div class="auth-inner row m-0">
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    ...
                    <form class="auth-reset-password-form mt-2" action="{{ route('recuperar-senha') }}" method="POST">
                        @csrf
                        <input type="hidden" name="usuarioId" id="usuarioId" value="{{ $dadosEmail['id'] }}">
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between">
                                <label for="reset-password-confirm">Confirma senha</label>
                            </div>
                            <div class="input-group input-group-merge form-password-toggle">
                        ...
                        <button class="btn btn-primary btn-block" tabindex="3">Definir nova senha</button>
                    </form>
                    <p class="text-center mt-2">
                        <a href="{{ route('login.inicial') }}">
                            <i data-feather="chevron-left"></i> Ir para o Login
                        </a>
                    </p>
                </div>
            </div>
