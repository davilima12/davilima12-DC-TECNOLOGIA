            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    <h2 class="card-title font-weight-bold mb-1">
                        A aventura começa aqui 🚀</h2>
                    <p class="card-text mb-2">Crie sua conta para desfrutar 7 dias gratis do sistema!</p>

                    <form class="auth-register-form mt-2" action={{ route('auth-register') }} method="POST">
                        @csrf
                        <input class="form-control" id="empresa_id" type="hidden" name="empresa_id" value="1" />
                        <div class="form-group">
                            <label class="form-label" for="name">Nome</label>
                            <input class="form-control @error('name') is-invalid @enderror" id="name" type="text"
                                value="{{ old('name') }}" required name="name" placeholder="exemplo"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('email') is-invalid @enderror" id="email" type="email"
                                value="{{ old('email') }}" required name="email" placeholder="exemplo@exemplo.com"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input class="form-control form-control-merge @error('password') is-invalid @enderror"
                                    id="password" required type="password" name="password" placeholder="············"
                                    value="{{ old('password') }}" aria-describedby="password" tabindex="3" />
